...
{
    public sealed class WhenPostingWithAValidContentType : IDisposable
    {
        private readonly HttpClient _client;
        private readonly HttpContent _content;
        private readonly WebApplicationFactory _webApplicationFactory;

        public WhenPostingWithAValidContentType()
        {
            ...
            _content.Headers.ContentType = new MediaTypeHeaderValue("text/plain");
        }
        ...
        [Fact]
        public async Task ThenTheStatusCodeOfTheResponseIsOk()
        {
